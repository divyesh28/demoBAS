		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo App For Git",
									"targetURL": "#nsgitdemoappgitdemoapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsgitdemoappgitdemoapp-display": {
								"semanticObject": "nsgitdemoappgitdemoapp",
								"action": "display",
								"description": "An SAP Fiori application for git deployment",
								"title": "Demo App For Git",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nsgitdemoapp.gitdemoapp",
									"url": sap.ui.require.toUrl("nsgitdemoapp/gitdemoapp")
								}
							}
						}
					}
